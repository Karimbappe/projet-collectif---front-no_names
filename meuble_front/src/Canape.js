...
const Canape = () => {
	...
	const fetchData = () => {
		fetch("http://localhost:8000/api/products/filter?category=Canapé")
			.then((response) => {
...
=======
        <><Navbar></Navbar><div class="cards_container">
            {Object.length > 0 && (
                <div className="gridable">
                    {Object.map((Object) => (
                        <div>
...
>>>>>>> 450782c (connected signup/login in front & back)
};
